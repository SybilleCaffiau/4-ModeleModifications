...
echo "après determize"
fstprint --isymbols=$label --osymbols=$label MdT_test_papier3.fst
...
fstcompose modeleEditionOmissionEvtModif.fst MdT_test_papier2.fst  | fstarcsort > Model_possible.fst
